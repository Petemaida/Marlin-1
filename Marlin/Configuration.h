...
#define STRING_CONFIG_H_AUTHOR "(Custom-PM, Ender-3 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Pete's BadAss"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -55, -25, -2.8 }
